...
``` {r, echo=FALSE, fig.width = 7, fig.align="center", warning=F, message=F}
    ...
    kable(wood_table1, digits=2, col.names = c("Trt", "Mean diameter", "Basal area",
                                               "Stem biomass", "Max height", 
                                               "Tree density"))  
...
``` {r, echo=FALSE, fig.width = 7, fig.align="center", warning=F}
    #soil.texture.information <- read.csv("temp_files/Soil_texture_information.csv")

    #ktable(soil.texture.information)    
